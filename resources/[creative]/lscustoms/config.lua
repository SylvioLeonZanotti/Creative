vehicleCustomisationPrices = {
	cosmetics = 1250,
	respray = 1250,
	engines = { 1000, 8000, 12000, 18000, 22000, 25000 },
	brakes = { 1000, 10000, 14000, 18000, 22000, 25000 },
	transmission = { 1000, 8000, 12000, 18000, 22000, 28000 },
	suspension = { 1000, 10000, 15000, 18000, 22000, 25000 },
	shield = { 1000, 15000, 20000, 25000, 30000, 35000 },
	turbo = 7250,
	wheels = 1250,
	customwheels = 1250,
	wheelsmoke = 775,
